...
namespace RBBot.Core.Exchanges.Kraken.Common
{
    public partial class KrakenClient
    {
        ...
        public async Task<KrakenResponse<List<DepositMethod>>> GetDepositMethods(
            string asset,
            string assetClass = null)
        {
            return await QueryPrivate<List<DepositMethod>>(
        ...
        public async Task<KrakenResponse<List<DepositAddress>>> GetDepositAddresses(
            string asset,
            string method,
            string newAddr = null,
            string assetClass = null)
        {
            return await QueryPrivate<List<DepositAddress>>(
                "/0/private/DepositAddresses",
                new Dictionary<string, string>(4 + AdditionalPrivateQueryArgs)
                {
                    ["aclass"] = assetClass,
                    ["asset"] = asset,
                    ["method"] = method, 
